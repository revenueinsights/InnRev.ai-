  ...
  return (
    <header className="w-full flex justify-between items-center mb-[15px]">
      ...
      <div className="flex items-center gap-[5px]">
        {/* <button className="w-[328px] p-[6px] min-h-[56px] bg-white rounded-full flex items-center justify-start gap-2 max-md:hidden">
          <div className="w-11 h-11 rounded-full bg-[#F6F6F6] grid place-items-center">
            <IoLocationOutline />
          </div>
          <div className="flex flex-col gap-1 items-start">
            <span className="text-[10px] text-[#7F7F7F]">Going to</span>
            <p className="text-[11px]">Roswell, New Mexico, United states</p>
          </div>
        </button> */}
